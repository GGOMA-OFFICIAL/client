...
class WorkScrapController extends GetxController {
  ...
  Future<bool> getScrapStatus(int postId) async {
    // JSON 파일 로드
    final String response = await rootBundle.loadString('assets/test/workscrap.json');
